...
const StudentDataTable = ({
  ...
  // Synchronize students with initialStudents when promotion/annee changes
  useEffect(() => {
    console.log("StudentDataTable: Updating students", {
      promotionId,
      promotionName,
      studentsCount: initialStudents.length,
    });
    setStudents(initialStudents);
  }, [promotionId, anneeId, initialStudents]);
  ...
  const handleDelete = async (subscriptionId: string) => {
    ...
    try {
      ...
      setStudents(
        students.filter((item) => item.subscription._id !== subscriptionId),
      );
    } catch (error) {
