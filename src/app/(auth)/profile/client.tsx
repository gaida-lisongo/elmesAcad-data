  ...
  return (
    <div className="py-20 px-6">
      <div className="container max-w-2xl">
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-4xl font-bold mb-2 text-black">Mon profil</h1>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <label className="cursor-pointer">
                      <div className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition flex items-center gap-2">
                        {uploadingPhoto ? (
                          <>
                            <Icon
